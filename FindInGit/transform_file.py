...
class FileTransformer:
    ...
    def create_new_data_frame(self):
        ...
        beginning_of_file = input("Please, enter an index of begining file row: ")
        ending_of_file = input("Please, enter an index of ending file row: ")
        if int(beginning_of_file) < self.number_of_rows and int(ending_of_file) < self.number_of_rows:
